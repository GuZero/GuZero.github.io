...
var update = __webpack_require__(3)("dd86ba24", content, false);
...
/* harmony default export */ exports["default"] = {
    ...
    methods: {
        ...
        searchOperator: function searchOperator() {
            ...
            that.nameList = [];
            setTimeout(function () {
                that.getAjaxRequest("terminal_cache", ajaxUrls.users + '?name=' + name, that.version, 2 * 60 * 1000, 6 * 60 * 60 * 1000, function (response) {
                    that.hideLoading();
                    that.isSearch = false;
