...
/******/ 		script.src = __webpack_require__.p + "" + ({"0":"OrderClose","1":"OrderInfo","2":"OrderCreate","3":"Mine","4":"EditPassword","5":"Transmit","6":"Terminal","7":"Search","8":"TerminalInfo","9":"Message","10":"Login","11":"Journal","12":"EquipmentInfo","13":"BasicInfo","14":"AdInfo","16":"SearchTerminal"}[chunkId]||chunkId) + "." + {"0":"21dd7a5f","1":"f6f34094","2":"7915e253","3":"64d3f0b5","4":"2b9ad8c4","5":"9f4814eb","6":"0844b50f","7":"8c08da79","8":"a9c0548f","9":"48e6e397","10":"6f4cc4c7","11":"d84acb4b","12":"48a68dd0","13":"6ba5e3bc","14":"24caad0a","16":"bd5f09a3"}[chunkId] + ".js";
...
var SearchTerminal = function SearchTerminal(r) {
    return __webpack_require__.e/* nsure */(16).catch(function(err) { __webpack_require__.oe(err); }).then((function () {
        return r(__webpack_require__(139));
    }).bind(null, __webpack_require__));
};
...
/* harmony default export */ exports["a"] = new VueRouter({
    ...
    routes: [{
        ...
        children: [{ path: '', component: BasicInfo }, { path: 'equipmentinfo', component: EquipmentInfo }, { path: 'journal', component: Journal }, { path: 'adinfo', component: AdInfo }]
    }, {
        path: '/mine',
        name: 'Mine',
        component: Mine
