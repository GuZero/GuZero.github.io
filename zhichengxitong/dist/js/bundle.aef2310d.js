...
module.exports = (_module$exports = {
    ...
    //搜索存件订单
    search: window.config.API + '/v1/delivery/orders?search='
}, _defineProperty(_module$exports, 'search', window.config.API + '/v1/fengchao/orders?search='), _defineProperty(_module$exports, 'search', window.config.API + '/v1/cainiao/orders?search='), _module$exports);
