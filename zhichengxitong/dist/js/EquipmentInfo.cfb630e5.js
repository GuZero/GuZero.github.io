...
var update = __webpack_require__(2)("791e025d", content, false);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        fetchData: function fetchData() {
            ...
            setTimeout(function () {
                axios.get(ajaxUrls.basic + that.$route.params.code + '?info=device').then(function (rsp) {
        ...
        QRScanSuccess: function QRScanSuccess(result) {
            saveEquipment(result);
        },
        QRScanFailed: function QRScanFailed(msg) {
