  ...
  return _c('div', {
    ...
    on: {
      "change": function($event) {
        _vm.$emit('changeCallback', this.value)
      }
    }
...
/* harmony default export */ exports["default"] = {
    ...
    created: function created() {
        ...
        //获取故障分类
        this.$on('changeCallback', function () {
            console.log('1');
        });
        if (!that.val == "") {
            var _that = this;
            axios.get(ajaxUrls.fault + _that.val).then(function (rsp) {
                var d = rsp.data;
                _that.problems = d.data;
                console.log(_that.problems);
            });
        }
    },
