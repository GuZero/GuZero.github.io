...
var update = __webpack_require__(3)("220e4a68", content, false);
...
/* harmony default export */ exports["default"] = _mixins$data$directiv = {
...
}, _defineProperty(_mixins$data$directiv, 'activated', function activated() {
    //开启<keep-alive>，会触发activated事件
    // this.resetScrollTop();
    window.addEventListener('scroll', this.handleScroll);
}), _defineProperty(_mixins$data$directiv, 'methods', {
