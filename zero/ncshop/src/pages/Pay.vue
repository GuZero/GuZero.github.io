    ...
    methods: {
        ...
        submitPay(order_id){
            ...
            if(pay_type == 4){
                ...
                if(window.ncshop_config && (window.ncshop_config.shop_alipay_account || window.ncshop_config.alipay_account)){
                    data.account = window.ncshop_config.shop_alipay_account || window.ncshop_config.alipay_account
                }
            }
