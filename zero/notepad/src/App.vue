<template>
    <div id="app" :class="[getTheme]">
        ...
        <section class="container" :class="{'hide':table}">
            <n-add></n-add>
            <n-list></n-list>
            <n-sidebar :is-show="tools" @cleardialog="clearData" @uploadData="uploadData" @opentable="table=true;tools=false" 
                        @opentheme="theme=true;tools=false"></n-sidebar>
        </section>
...
export default {
    ...
    components: {
        nHeader, nAdd, nSidebar, nDialog, nTable, nList, nTheme
    },
    computed:{
        getTheme(){
