        ...
        getInfo: function getInfo() {
            ...
            getAjaxRequest("order_cache", ajaxUrls.option, that.version, 20 * 1000, 0.5 * 60 * 60 * 1000, function (response) {
                ...
                if (response.status == 0) {
                    ...
                    try {
                        for (var _iterator2 = Object.keys(arr)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            //                           that.scenes.push('id')index;
