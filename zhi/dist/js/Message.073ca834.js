...
var update = __webpack_require__(4)("0d5dad84", content, false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_common_DataLoading__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_common_DataLoading___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_common_DataLoading__);
...
/* harmony default export */ __webpack_exports__["default"] = (_data$mixins$componen = {
    data: function data() {
        return {
            pageTitle: '消息中心',
            bodyBg: 'gray',
    ...
    components: {
        ...
        //            FooterBar,
        DataLoading: __WEBPACK_IMPORTED_MODULE_1__components_common_DataLoading___default.a
    },
...
}, _defineProperty(_data$mixins$componen, 'beforeRouteLeave', function beforeRouteLeave(to, from, next) {
    if (to.path == '/message') {
        window.localStorage.setItem('homeToMessage', '1');
    }
    next();
}), _defineProperty(_data$mixins$componen, 'destroyed', function destroyed() {
    this;
}), _defineProperty(_data$mixins$componen, 'filters', {
...
}), _defineProperty(_data$mixins$componen, 'methods', {
    ...
    fetchData: function fetchData() {
        ...
        if (that.isFirst) {
            getAjaxRequest("message_cache", ajaxUrls.messages + 'numbers', that.version, 5 * 1000, 6 * 60 * 60 * 1000, function (response) {
        ...
        that.showLoading();
        getAjaxRequest("message_cache", ajaxUrls.messages + that.filter + "?page=" + that.page, that.version, 5 * 1000, 6 * 60 * 60 * 1000, function (response) {
            if (response.status == 0) {
