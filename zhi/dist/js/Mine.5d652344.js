...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }), _c('p', [_vm._v(_vm._s(_vm.username))])]), _c('div', {
...
var update = __webpack_require__(4)("65a06c2c", content, false);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("82e64980", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony default export */ exports["default"] = {
    ...
    created: function created() {
        ...
        window.origin = null;
        var userJson = JSON.parse(window.localStorage.userJson || null);
        if (userJson) {
