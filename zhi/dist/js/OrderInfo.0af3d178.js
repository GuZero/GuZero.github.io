...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "rel s3"
  }, [_vm._v(_vm._s(_vm.data.status))])]) : _vm._e()]), _c('div', {
  ...
  })), (!_vm.isAuthor && !_vm.completed || !_vm.isAdmin && !_vm.completed) ? _c('SubmitBtn', {
    attrs: {
      "text": "跟进"
    },
    on: {
      "submitCallback": function($event) {
        _vm.showAlert('follow')
      }
    }
  }, [_vm._v("跟进")]) : _vm._e(), (_vm.isAuthor && !_vm.completed || _vm.isAdmin && !_vm.completed) ? _c('div', {
  ...
  }, [_vm._v("删除")]) : _vm._e(), (_vm.isAuthor || _vm.isAdmin) ? _c('div', {
    staticClass: "rel",
    class: {
      w50: _vm.isAuthor, flexmodel: _vm.isAdmin, w33: _vm.isAdmin
    },
    on: {
      "click": function($event) {
        _vm.showAlert('follow')
  ...
  }, [_vm._v("跟进")]) : _vm._e(), (_vm.isAdmin) ? _c('div', {
    staticClass: "flexmodel rel",
    class: {
      w33: _vm.isAdmin
    },
  ...
  }, [_vm._v("关闭")]) : _vm._e(), (_vm.isAdmin) ? _c('div', {
    staticClass: "rel none",
    class: {
      w33: _vm.isAdmin
    },
    on: {
  ...
  }, [_vm._v("转发")]) : _vm._e()]) : _vm._e()], 1), _c('ModalDialog', {
    ref: "showalert",
    on: {
...
var update = __webpack_require__(4)("5199ddfb", content, false);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(4)("7c4c54d2", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_elements_Text__ = __webpack_require__(111);
        ...
        getData: function getData() {
            ...
            getAjaxRequest("order_cache", ajaxUrls.orderinfo + that.$route.params.id, that.version, 10 * 1000, 0.5 * 60 * 60 * 1000, function (response) {
                ...
                if (response.status == 0) {
                    ...
                    //创建人ID
                    var creator_id = response.data.creator.id;
                    //当前用户ID
                    var current_id = response.data.current_user.id;
                    //执行人ID
                    var owner_id = response.data.owner.id;
