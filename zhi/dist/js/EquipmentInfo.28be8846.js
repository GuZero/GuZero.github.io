...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), (_vm.isNoNetwork) ? [_c('div', {
    staticClass: "no-network"
  }, [_c('img', {
    staticClass: "no-network-img",
    attrs: {
      "src": "//img.aimoge.com/Fm6Kur5_5IsfnlIiRR2nErPqZkwE"
    }
  }), _c('div', {
    staticClass: "no-network-info"
  }, [_vm._v("暂无网络")]), _c('div', {
    staticClass: "reload",
    on: {
  ...
  }, [_vm._v("重新加载")])])] : _vm._e(), (!_vm.isNoNetwork) ? [_c('div', {
    staticClass: "boxlist mt44"
  }, [_c('div', {
    staticClass: "title"
  }, [_vm._v("箱柜列表")]), _c('ul', _vm._l((_vm.bins), function(item, index) {
    return _c('li', {
      key: item.rack_id,
      staticClass: "item"
    }, [_c('div', {
      ...
      staticClass: "label"
    }, [_vm._v(_vm._s(item.position))]), (item.asset_num) ? [_c('p', {
      staticClass: "info ellipsis"
    }, [_vm._v(_vm._s(item.asset_num))])] : _vm._e(), (!item.asset_num) ? [_c('p', {
    ...
    staticClass: "title"
  }, [_vm._v("其他设备")]), _c('ul', _vm._l((_vm.other), function(item, index) {
    return _c('li', {
      key: item.id,
      staticClass: "item"
    }, [_c('div', {
      ...
      staticClass: "label"
    }, [_vm._v(_vm._s(item.name))]), (item.asset_num) ? [_c('p', {
      staticClass: "info ellipsis",
      on: {
        "click": function($event) {
          $event.stopPropagation();
          $event.preventDefault();
          _vm.goToEidtEquipment('device_id', item.id, item.asset_num)
        }
      }
    }, [_vm._v(_vm._s(item.asset_num))])] : _vm._e(), (!item.asset_num) ? [_c('p', {
      staticClass: "info unactive",
    ...
    }, [_vm._v("未填写")])] : _vm._e(), _c('i', {
      staticClass: "scan",
      on: {
        "click": function($event) {
          $event.stopPropagation();
          $event.preventDefault();
          _vm.goToScan('device_id', item.id, index)
        }
      }
    })], 2)])
  }))])] : _vm._e(), _c('TransmitFooter', {
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2c829b62", module.exports)
  }
}
...
var update = __webpack_require__(4)("791e025d", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-2c829b62\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EquipmentInfo.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-2c829b62\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/sass-loader/lib/loader.js!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./EquipmentInfo.vue");
...
Component.options.__file = "C:\\workspace\\zhichengxitong\\src\\pages\\EquipmentInfo.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2c829b62", Component.options)
  } else {
    hotAPI.reload("data-v-2c829b62", Component.options)
  }
})()}
        ...
        saveEquipment: function saveEquipment(asset_num) {
            ...
            axios.post(finishUrl, postData, {
                ...
                if (rsp.data.status == 0) {
                    if (that.current_type == 'rack_id') {
                        var array = [].concat(that.bins);

                        var item = array[that.current_index];
                        ...
                        var _array = [].concat(that.other);
                        var _item = _array[that.current_index];
                        _item.asset_num = asset_num;
                        _array.splice(that.current_index, 1, _item);
                        that.other = [].concat(_array);
...
// module
exports.push([module.i, "\n.gray_2[data-v-2c829b62] {\n  color: #e3e3e3;\n}\n.equipmentinfo[data-v-2c829b62] {\n  padding-bottom: 60px;\n}\n.equipmentinfo .title[data-v-2c829b62] {\n    height: 32px;\n    line-height: 32px;\n    color: #747474;\n    padding: 0 16px;\n}\n.equipmentinfo .no-network[data-v-2c829b62] {\n    padding-top: 159px;\n}\n.equipmentinfo .no-network .no-network-img[data-v-2c829b62] {\n      display: block;\n      width: 122px;\n      height: 122px;\n      margin: 0 auto 16px;\n}\n.equipmentinfo .no-network .no-network-info[data-v-2c829b62] {\n      font-size: 14px;\n      color: #6e6e6e;\n      text-align: center;\n}\n.equipmentinfo .no-network .reload[data-v-2c829b62] {\n      margin: 42px auto 0;\n      background: #07689f;\n      height: 40px;\n      line-height: 40px;\n      width: 160px;\n      color: #fff;\n      font-size: 16px;\n      text-align: center;\n      border-radius: 24px;\n}\n.equipmentinfo ul[data-v-2c829b62] {\n    padding-left: 16px;\n    background-color: #fff;\n}\n.equipmentinfo ul li[data-v-2c829b62] {\n      background-color: #fff;\n      color: #4d4d4d;\n      font-size: 13px;\n      overflow: hidden;\n      width: 100%;\n      left: 0;\n      position: relative;\n      box-sizing: border-box;\n}\n.equipmentinfo ul li[data-v-2c829b62]:nth-child(1):before {\n        height: 0;\n}\n.equipmentinfo ul li[data-v-2c829b62]:before {\n        content: '';\n        display: block;\n        position: absolute;\n        top: 0;\n        width: 100%;\n        height: 1px;\n        background-color: #979797;\n        transform: scale(1, 0.5);\n}\n.equipmentinfo ul li:before p[data-v-2c829b62] {\n          text-align: left;\n}\n.equipmentinfo ul li .item-info[data-v-2c829b62] {\n        padding: 10px 50px 10px 80px;\n        box-sizing: border-box;\n}\n.equipmentinfo ul li .item-info .label[data-v-2c829b62] {\n          width: 80px;\n          position: absolute;\n          top: 50%;\n          left: 0;\n          height: 22px;\n          line-height: 22px;\n          margin-top: -11px;\n}\n.equipmentinfo ul li .item-info .info.unactive[data-v-2c829b62] {\n          color: #cfcfcf;\n}\n.equipmentinfo ul li .scan[data-v-2c829b62] {\n        content: '';\n        background: url(\"//img.aimoge.com/Fl1S3WqI_mdGIBD2toXw4pqk62g-\") 0 0 no-repeat;\n        background-position: center center;\n        background-size: 14px auto;\n        display: block;\n        height: 44px;\n        width: 44px;\n        position: absolute;\n        right: 16px;\n        top: 50%;\n        margin-top: -22px;\n}\n.equipmentinfo .device[data-v-2c829b62] {\n    width: 100%;\n}\n.equipmentinfo .device ul[data-v-2c829b62] {\n      overflow: auto;\n}\n.equipmentinfo .device ul li p[data-v-2c829b62]:nth-child(2) {\n        width: 75%;\n}\n", ""]);
