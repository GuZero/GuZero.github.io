...
/* harmony default export */ exports["default"] = {
    ...
    methods: {
        ...
        fetchData: function fetchData() {
            ...
            if (that.isFirst) {
                getAjaxRequest("message_cache", ajaxUrls.messages + 'numbers', that.version, 2 * 60 * 1000, 6 * 60 * 60 * 1000, function (response) {
            ...
            that.showLoading();
            getAjaxRequest("message_cache", ajaxUrls.messages + that.filter + "?page=" + that.page, that.version, 10 * 1000, 6 * 60 * 60 * 1000, function (response) {
                if (response.status == 0) {
