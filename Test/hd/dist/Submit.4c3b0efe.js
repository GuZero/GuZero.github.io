...
/* harmony default export */ __webpack_exports__["default"] = ({
        ...
        '$route': function $route() {
            if (this.$route.path == '/submit') {
                ...
                if (window.Data.c_id && window.Data.c_name) {
                    var arr3 = Array.from(window.Data.c_id);
                    var arr4 = Array.from(window.Data.c_name);
    ...
    methods: {
        ...
        setData1: function setData1(arr1, arr2) {
            var Array = [];
            for (var i = 0; i < arr1.length; i++) {
                var obj = Object.create(null);
                obj.city_id = arr1[i];
        ...
        verify: function verify(cityID, code) {
            axios.get('http://api.dev.aimoge.com/v1/media/adinteraction/inspect?city_id=' + cityID + '&terminal_codes=' + code + '&start_date=' + this.start_date + '&end_date=' + this.end_date).then(function (response) {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(23), __webpack_require__(0)))
