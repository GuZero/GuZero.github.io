...
var baseDir = '/ncshop-www/templates/gegeplus/';
...
module.exports = {
    ...
    output: {
        ...
        /* 输出目录，没有则新建 */
        path: __dirname + '/ncshop-www/static/gegeplus/dist/',
        /* 静态目录，可以直接从这里取文件 */
        publicPath: '/static/gegeplus/dist/',
    ...
    plugins: [
        ...
        new CleanWebpackPlugin([__dirname + '/ncshop-www/static/gegeplus/dist/']),
    ]
}